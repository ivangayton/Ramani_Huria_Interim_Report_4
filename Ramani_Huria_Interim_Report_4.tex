...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[width=0.4\textwidth]{images/Magomeni_Before_Re-digitization.png}
\end{figure}

\begin{figure}[h]
  \color{RHgreen}\caption{Map showing Magomeni ward after re-digitization using UAV imagery}
  \centering
  \includegraphics[width=0.4\textwidth]{images/Magomeni_After_Re-digitization.png}
\end{figure}
