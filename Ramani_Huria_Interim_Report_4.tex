...
\usepackage{footnote}
\makesavenoteenv{tabular} %For creating footnotes in a table
...
Ramani Huria 2.0 is next to last in June 2019. During this phase, we have collected a number of datasets that can serve for several purposes including the primary focus of the project, creating maps for flood resilience in the city. 
...
This overview of digital datasets is an annex to the final project report to be submitted in June 2019. It contains a brief summary of the dataset, spatial extent, methodology used for data collection, data model and/or survey form used, methods used to review data quality, data gap, timeline, statistics, visualization of data, link to access the data, licencing (incase of data sharing), data use case and lessons learned throughout the process of data collection.

Ramani Huria team conducted a number of activities including Community Flood Response following the heavy rainfall on March 3rd 2019, Soil sediment analysis for geomorphological assessment of the city and erosion modeling, participated in Innovation Week on March 2019 to showcase how we conducted sediment analysis using cheap yet practical methods and came out with professional results and the ongoing River Mapping activities---flying drones along the major rivers of Dar es Salaam to  provide a digital photographic mark-up of the current status of Dar es Salaam’s waterways, to help in solid waste management on major rivers of the city.
...
\label{Introduction}
 ...
 This report describes the activities of Ramani Huria 2.0 from October to April providing an overview of digital assets collected since October 2018. 
\bigskip
...
\hline
Finished & RHgreen & \#27a73b & {\colorbox{RHgreen}{   }} \\
\hline
RH data collection pending i.e. working on it & RHblue & \#3a8fcc & {\colorbox{RHblue}{   }} \\
\hline
Should be followed up on by the Resilience Academy & RHyellow & \#f8c910 & {\colorbox{RHyellow}{   }} \\
\hline
Outside scope of interest & RHgrey & \#e4e4e4 & {\colorbox{RHgrey}{   }} \\
\hline
Data collected but still not analyzed & RHolive & \#eff07d & {\colorbox{RHolive}{   }} \\
\hline
\end{tabular}
...
\section{Datasets}
In this case, a dataset contains all digital assets/ data collected by Ramani Huria from October to March. Not all data can contain characteristics of a 'dataset' but rather provide an overview of the data collected in the Ramani Huria project. The following is a list of datasets presented in the same format for consistency. 
\subsection{Drainage}
...
\begin{center}
 ...
 \multirow {Access}
       ...
       & \multicolumn{1}{l}{\href{https://geonode.uhurulabs.org/layers/geonode\%3ADrain\%20Segments}{UhuruLabs\_Drain Segments}\footnote{\url{https://geonode.uhurulabs.org/layers/geonode\%3ADrain\%20Segments}}} \\ 
 \hline      
  Licensing & CC-BY 4.0 \\
 \hline
\end{tabular}
...
\subsubsection{Data Visualization}
\begin{figure}[h]
{\color{RHgreen}\caption{Map showing Risk Identification of Kawe Ward}}
 \centering
...
\newpage
\subsection{Hyper-local Boundary Mapping}
...
\multirow {Access}
       & \multicolumn{1}{l}
       {\href{http://dar-trash-viz.herokuapp.com/}{Visualied in Application}\footnote{\url{http://dar-trash-viz.herokuapp.com/}}}\\
       & \multicolumn{1}{l}{\href{https://drive.google.com/file/d/1asvYaiCwnR-SO-GaJwGAURHFEOndLuri/view?usp=sharing_eil&ts=5cb889ca}{Dar-Trash-with-Image-Path.geojson} \footnote{\url{https://drive.google.com/file/d/1asvYaiCwnR-SO-GaJwGAURHFEOndLuri/view?usp=sharing_eil&ts=5cb889ca}}}\\ 
\hline
