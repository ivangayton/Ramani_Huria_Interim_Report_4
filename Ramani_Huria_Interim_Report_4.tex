...
\begin{center}
%temp image {\includegraphics[width=5cm]{Dar_Ramani_Huria_logo.png}}
\end{center}
...
%temp image \includegraphics[width=0.8\textwidth]{sample_locations.jpg}
...
\newpage
\section{Datasets}
In this case, a dataset contains all digital assets/ data collected by Ramani Huria from 2017 to 2019. Not all data can contain characteristics of a 'dataset' but rather provide an overview of the data collected in the Ramani Huria project. The following is a list of datasets presented in the same format for consistency, and listed in no particular order.
\subsection{Drainage}
...
\begin{figure}[h]
  ...
  \centering
  %temp image \includegraphics[width=0.8\textwidth]{images/Drain_Mapping.png}
\end{figure}
...
\begin{figure}[h]
 \color{RHgreen}\caption{A detailed image showing the drainage channel flow in Dar es Salaam.}
  %temp image \includegraphics[width=0.8\textwidth]{images/Drainage_Visualization.jpeg}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
  %temp image \includegraphics[width=0.8\textwidth]{images/soil_sample_locations.jpg}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
 %temp image  \includegraphics[width=1\textwidth]{soil_map_detail_peninsula_with_legend}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
  %temp image \includegraphics[width=0.8\textwidth]{images/Asset&Threat.png}
\end{figure}
\subsubsection{Data Collection Methodology}
\begin{multicols}{2}
...
{\color{RHgreen}\caption{A detailed map showing Risk Identification of Kawe Ward. The red dots show assets that are at risk of flooding}}
 \centering
 %temp image \includegraphics[width=0.7\textwidth]{Asset_visualization.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/Building_Footprint_Digitization.png}
\end{figure}
...
\begin{tabular}{|c@{}c|}
  \hline
 %temp image \includegraphics[width=0.5\textwidth]{images/Magomeni_Before_Redigitization.png}&%
    %temp image \includegraphics[width=0.5\textwidth]{images/Magomeni_After_Redigitization.png}\\
 %temp image \includegraphics[width=0.5\textwidth]{images/Detailed_Magomeni_Before_Redigitization.png}&%
  %temp image   \includegraphics[width=0.5\textwidth]{images/Detailed_Magomeni_After_Redigitization.png}\\
  \hline
\end{tabular}
...
Hyper-local boundaries are divisions within subwards regarded as political boundaries previously referred to as ten cell divisions as they were originally comprised of ten households.
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/hyperlocal_boundary.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/Shinas_Data_Viz.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/GWPL.png}
\end{figure}
...
\begin{itemize}
    \item JOSM is used to check if buildings and other necessary information have been tagged correctly for example, checking spellings, tags, etc. 
...
\begin{figure}
  ...
  %temp image  \includegraphics[width=\textwidth]{images/GWPL_client_map.png}
   \color{RHgreen}\caption{Map showing detailed collected points at Kisutu ward}
    \label{fig:1}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
  %temp image  \includegraphics[width=\textwidth]{images/GWPL_client_tracking_system.png}
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/JCL_Trash_Mapping.png}
\end{figure}
\newpage
\subsubsection{Methodology}
\begin{multicols}{2}
...
\begin{figure}
  \begin{subfigure}[b]{0.5\textwidth}
  %temp image  \includegraphics[width=\textwidth]{images/Msimbazi_mama.png}
   \color{RHgreen}\caption{A map showing client distribution, houses and hyperlocal boundaries in Msimbazi Mama}
    \label{fig:1}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
  %temp image  \includegraphics[width=\textwidth]{images/Msimbazi_magharibi.png}
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/Dar_Trash_Map.png}
\end{figure}
...
\subsubsection{Quality Control}
QGIS was used to remove bag full and handful categories.
...
These categories were far too small to be collected and sometimes confused the mappers therefore a decision to remove these points had to be made which dropped the number of points to approximately 9,000.
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/dar_trash.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/flood_response.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
   %temp image \includegraphics[width=0.7\textwidth]{images/Flood_Response_Data_Viz.png}
\end{figure}
...
\subsubsection{Data Gaps}
We did community flood response for only 3 wards which were affected with floods but were not able to visit other wards which were also affected.
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{Flood_Extent.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \centering
 %temp image \includegraphics[width=0.8\textwidth]{images/Flood_Extent_Visualization.PNG}
\end{figure}
